...
//        this.watches[lit].push(c);
  //  }
    ...
    public String toString() {
         ...
         buf.append(" } ");
         buf.append(" | ");
         buf.append("falsified = { ");
         for (int i = 0 ; i < falsified.length ; i++) {
 			 buf.append(falsified[i]);
 			 if(!(i == falsified.length-1))
 	 			 buf.append(" , ");
 		}
         buf.append(" } ");
         return buf.toString(); 
